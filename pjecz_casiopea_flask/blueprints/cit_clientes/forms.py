...
class CitClienteForm(FlaskForm):
    ...
    contrasena = PasswordField("Contraseña (8 a 24 caracteres: mayúsculas, minúsculas y números)", validators=[Optional(), Regexp(PASSWORD_REGEXP)])
    limite_citas_pendientes = IntegerField("Límite de citas pendientes (1 a 100)", validators=[DataRequired(), NumberRange(1, 100)])
