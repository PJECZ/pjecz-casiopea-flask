"""
Communications, enviar a Sendgrid un mensaje para validar
"""
...
def enviar_a_sendgrid_mensaje_validar(cit_cliente_registro_id: str) -> tuple[str, str, str]:
    ...
    # Validar que ya_registrado NO SEA verdadero
    ...
    mensaje_termino = f"Se ha enviado un mensaje por Sendgrid a {cit_cliente_registro.email} para validar."
